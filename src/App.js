...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="res-card" >
            ...
            alt="res-logo"
            src="https://www.shutterstock.com/image-photo/fried-salmon-steak-cooked-green-600nw-2489026949.jpg"></img>
            <h3>{name} </h3>
            <h4>{cuisines.join(", ")} </h4>
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                {
                    restaurantList.map(restaurant => <RestaurantCard resData = {restaurant} key = {restaurant.data.id} />)
